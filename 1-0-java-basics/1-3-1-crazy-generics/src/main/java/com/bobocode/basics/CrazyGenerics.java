...
public class CrazyGenerics {
     ...
     */
    interface ComparableCollection<E> extends Collection<E>, Comparable<Collection<?>> { // refactor it to make generic and provide a default impl of compareTo
    ...
    static class CollectionUtil {
        ...
        public static <T extends BaseEntity> boolean isValidCollection(Collection<? extends BaseEntity> entities,
            ...
            /*        throw new ExerciseNotCompletedException(); // add method parameters and implement the logic
             */
        }
        ...
        public static <T extends BaseEntity> boolean hasDuplicates(Collection<T> entities, T targetEntity) {
            return entities.stream()
                    ...
                    .count() > 1;
            /*     throw new ExerciseNotCompletedException(); // pdate method signature and implement it
             */
        }
